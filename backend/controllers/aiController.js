...
export const enhanceProfessionalSummary = async (req, res) => {
  try {
    ...
    console.log('Error enhanceProfessionalSummary Controller: ', error.message);
...
export const enhanceJobDescription = async (req, res) => {
  try {
    ...
    console.log('Error enhanceJobDescription Controller: ', error.message);
    return res.status(500).json({
      message: error.message,
    });
  }
...
export const uploadResume = async (req, res) => {
  try {
    ...
    console.log('Error uploadResume Controller: ', error.message);
    return res.status(500).json({
      message: error.message,
    });
  }
